    ...
    while (pilih==0)
    {
        ...
        case 5:
            ...
            case 6:
                ...
                showRelasiParentToChild(L1, L3);
                cout<<"======================================================"<<endl;
                cout<<"Back To Menu? [Press y/Y] : "<<jawab<<endl;
                while ((jawab != 'y') || (jawab != 'Y')){
                    cout<<"Back To Menu? [Press y/Y] : "<<jawab<<endl;
                }
                if ((jawab == 'y') || (jawab == 'Y'))
            ...
            case 8:
                ...
                cin>>nim;
                system("CLS");
                cout<<"Lomba yang diikuti oleh peserta dengan nim : "<<nim << endl;
            ...
            case 9:
                ...
                cout<< "Kejuaraan Paling Diminati : " << m << endl;
                cout<<endl;
                cout<<"=================================================================="<<endl;
                ...
                cout << "Peserta yang mengikuti lomba paling sedikit : "<<n<<endl;
                cout<<endl;
                cout<<"=================================================================="<<endl;
                cout<<"=================================================================="<<endl;
                cout<<"=================================================================="<<endl;
